...
workflow REFERENCE_RETRIEVAL {
    ...
    emit:
        reference_genome                        = BIODBCORE_REFSEQ.out.reference_genome    // reference_genome
        reference_genome_ungapped_size          = reference_genome_ungapped_size           // reference_genome_ungapped_size
