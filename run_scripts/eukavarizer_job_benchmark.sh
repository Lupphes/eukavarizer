...
cp "$DATADIR/eukavarizer/data/9606/ref/GCA_000001405.15_GRCh38_no_alt_analysis_set.fna.gz" "$SCRATCH/reference/"
echo "Reference ready at $SCRATCH/reference/GCA_000001405.15_GRCh38_no_alt_analysis_set.fna.gz" | tee -a "$LOGFILE"
...
"$SCRATCH/nextflow" run main.nf -profile mamba,long_full,qc_off \
    --taxonomy_id 9606 \
    --reference_genome "$SCRATCH/reference/GCA_000001405.15_GRCh38_no_alt_analysis_set.fna.gz" \
