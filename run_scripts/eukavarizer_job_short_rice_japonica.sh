#!/bin/bash
#========================================================================================
# PBS Job: Eukavarizer Pipeline - Oryza sativa (Rice Japonica, Taxonomy 39947)
#========================================================================================
#PBS -N eukavarizer_rice_39947_japonica
#PBS -l select=1:ncpus=16:mem=256gb:scratch_local=2000gb
#PBS -l walltime=24:00:00
#PBS -m abe
#PBS -M ondrej.sloup@protonmail.com
#PBS -j oe
#PBS -o /storage/brno2/home/luppo/logs/eukavarizer_rice_39947_japonica.log

#========================================================================================
# Configuration
#========================================================================================
# Sample: Oryza sativa Japonica Group (Rice Japonica)
# Taxonomy ID: 39947
# Reference: ASM3414082v1 (GCF_034140825.1) - Japonica reference
# Profile: rice_japonica (Delly, Manta, Dysgu, Tiddit, SVABA, Sniffles, CuteSV)
# Run type: Short reads (Illumina)

DATADIR=/storage/brno2/home/luppo
SCRATCH=$SCRATCHDIR
LOGFILE="$DATADIR/rice_39947_japonica/logs/eukavarizer.log"
...
echo "=== Eukavarizer Pipeline: Rice Japonica (39947) ===" | tee -a "$LOGFILE"
...
export NXF_WORK="$DATADIR/rice_39947_japonica/work"
export NXF_LOG_FILE="$DATADIR/rice_39947_japonica/logs/.nextflow.log"
...
sed "s|\$DATADIR|$DATADIR|g" "$DATADIR/eukavarizer/assets/samplesheets/samplesheet_rice_japonica.csv" > "$SCRATCH/samplesheet_formatted.csv"
...
"$SCRATCH/nextflow" run main.nf -profile mamba,rice_japonica,qc_off \
    ...
    --outdir "$DATADIR/rice_39947_japonica/out" | tee -a "$LOGFILE"
