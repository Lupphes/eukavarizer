#!/bin/bash
#========================================================================================
# PBS Job: Eukavarizer Pipeline - Homo sapiens (Human, Taxonomy 9606) - Benchmark Q100
#========================================================================================
#PBS -N eukavarizer_human_9606_benchmark_q100
#PBS -l select=1:ncpus=16:mem=768gb:scratch_local=1000gb
#PBS -l walltime=24:00:00
#PBS -m abe
#PBS -M ondrej.sloup@protonmail.com
#PBS -j oe
#PBS -o /storage/brno2/home/luppo/logs/eukavarizer_human_9606_benchmark_q100.log
...
# Taxonomy ID: 9606
# Reference: T2T-CHM13 (Telomere-to-Telomere Complete Human Genome)
# Profile: long_full (Delly, Manta, Sniffles, CuteSV)
# Run type: Benchmark with Q100 (T2T reference)

DATADIR=/storage/brno2/home/luppo
SCRATCH=$SCRATCHDIR
LOGFILE="$DATADIR/human_9606_benchmark_q100/logs/eukavarizer.log"
...
echo "=== Eukavarizer Pipeline: Human (9606) - Benchmark Q100 (T2T) ===" | tee -a "$LOGFILE"
...
export NXF_LOG_FILE="$DATADIR/human_9606_benchmark_q100/logs/.nextflow.log"
...
"$SCRATCH/nextflow" run main.nf -profile mamba,long_full,qc_off \
    ...
    --outdir "$DATADIR/human_9606_benchmark_q100/out" \
