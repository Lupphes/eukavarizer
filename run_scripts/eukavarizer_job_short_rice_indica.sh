#!/bin/bash
#========================================================================================
# PBS Job: Eukavarizer Pipeline - Oryza sativa (Rice Indica, Taxonomy 39946)
#========================================================================================
#PBS -N eukavarizer_rice_39946_indica
#PBS -l select=1:ncpus=16:mem=256gb:scratch_local=2000gb
#PBS -l walltime=24:00:00
#PBS -m abe
#PBS -M ondrej.sloup@protonmail.com
#PBS -j oe
#PBS -o /storage/brno2/home/luppo/logs/eukavarizer_rice_39946_indica.log

#========================================================================================
# Configuration
#========================================================================================
# Sample: Oryza sativa Indica Group (Rice Indica)
# Taxonomy ID: 39946
# Reference: ZS97RS3 (GCA_001623345.3) - Indica reference
...
SCRATCH=$SCRATCHDIR
LOGFILE="$DATADIR/rice_39946_indica/logs/eukavarizer.log"
...
echo "=== Eukavarizer Pipeline: Rice Indica (39946) ===" | tee -a "$LOGFILE"
...
export NXF_LOG_FILE="$DATADIR/rice_39946_indica/logs/.nextflow.log"
...
cp "$DATADIR/eukavarizer/data/39946/ref/GCA_001623345.3_ZS97RS3_genomic.fna.gz" "$SCRATCH/reference/"
echo "Reference ready at $SCRATCH/reference/GCA_001623345.3_ZS97RS3_genomic.fna.gz" | tee -a "$LOGFILE"
...
"$SCRATCH/nextflow" run main.nf -profile mamba,rice_indica,qc_off \
    --reference_genome "$SCRATCH/reference/GCA_001623345.3_ZS97RS3_genomic.fna.gz" \
    --input "$SCRATCH/samplesheet_formatted.csv" \
    --outdir "$DATADIR/rice_39946_indica/out" | tee -a "$LOGFILE"
