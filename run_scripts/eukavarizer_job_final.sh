#!/bin/bash
#========================================================================================
# PBS Job: Eukavarizer Pipeline - Homo sapiens (Human, Taxonomy 9606) - Final
#========================================================================================
#PBS -N eukavarizer_human_9606_final
#PBS -l select=1:ncpus=64:mem=512gb:scratch_local=400gb
#PBS -l walltime=24:00:00
#PBS -m abe
#PBS -M ondrej.sloup@protonmail.com
#PBS -j oe
#PBS -o /storage/brno2/home/luppo/logs/eukavarizer_human_9606_final.log
...
# Run type: Final production run

DATADIR=/storage/brno2/home/luppo
SCRATCH=$SCRATCHDIR
LOGFILE="$DATADIR/human_9606_final/logs/eukavarizer.log"
...
echo "=== Eukavarizer Pipeline: Human (9606) - Final ===" | tee -a "$LOGFILE"
...
export NXF_WORK="$DATADIR/human_9606_final/work"
export NXF_LOG_FILE="$DATADIR/human_9606_final/logs/.nextflow.log"
...
"$SCRATCH/nextflow" run main.nf -profile mamba,mix_medium,qc_off \
    ...
    --outdir "$DATADIR/human_9606_final/out" \
    --seqtk_size 1.0 --seqtk_flag false | tee -a "$LOGFILE"
