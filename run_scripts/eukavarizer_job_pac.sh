...
#PBS -j oe
#PBS -o /storage/brno2/home/luppo/logs/eukavarizer_human_9606_pacbio.log
...
# Run type: PacBio long reads

DATADIR=/storage/brno2/home/luppo
SCRATCH=$SCRATCHDIR
LOGFILE="$DATADIR/human_9606_pacbio/logs/eukavarizer.log"
...
echo "=== Eukavarizer Pipeline: Human (9606) - PacBio ===" | tee -a "$LOGFILE"
...
export NXF_WORK="$DATADIR/human_9606_pacbio/work"
export NXF_LOG_FILE="$DATADIR/human_9606_pacbio/logs/.nextflow.log"
...
"$SCRATCH/nextflow" run main.nf -profile mamba,long_full,qc_off \
    ...
    --outdir "$DATADIR/human_9606_pacbio/out" \
