...
sed "s|\$DATADIR|$DATADIR|g" "$DATADIR/eukavarizer/conf/samplesheets/samplesheet_rice_japonica.csv" > "$DATADIR/eukavarizer/conf/samplesheets/samplesheet_formatted.csv"
