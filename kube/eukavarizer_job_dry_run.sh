...
SCRATCH=$SCRATCHDIR
LOGFILE="$DATADIR/dry_run_job/logs/eukavarizer_job_sad.log"
...
export NXF_LOG_FILE=$DATADIR/dry_run_job/logs/.nextflow.log
...
../nextflow run main.nf -profile mamba,mix_medium,qc_off \
    ...
    --outdir "$DATADIR/dry_run_job/out" | tee -a "$LOGFILE"
